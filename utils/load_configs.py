...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--model_name', type=str, default='STAMPEDE', help='name of the model',
                        choices=['JODIE', 'DyRep', 'TGAT', 'TGN', 'CAWN', 'TCL', 'GraphMixer', 'DyGFormer', 'DyGMamba', 'STAMPEDE'])
    ...
    parser.add_argument('--max_interaction_times', type=int, default=10, help='max interactions for src and dst to consider')
    parser.add_argument('--load_best_configs', action='store_true', default=False, help='whether to load the best configurations')

    # --- STAMPEDE Framework Arguments ---
    parser.add_argument('--fusion_method', type=str, default='clifford', help='Fusion strategy for STAMPEDE',
                        choices=['clifford', 'caga', 'weighted', 'concat_mlp', 'cross_attention'])
    parser.add_argument('--embedding_type', type=str, default='all', help='Which embeddings to use in the GNN backbone',
                        choices=['all', 'only_spatial', 'only_temporal', 'only_st', 'none'])
    parser.add_argument('--spatial_dim', type=int, default=32, help='Dimension of the spatial embedding for fusion')
    parser.add_argument('--temporal_dim', type=int, default=32, help='Dimension of the temporal embedding for fusion')
    parser.add_argument('--output_dim', type=int, default=64, help='Final output dimension of the fused embedding')
    parser.add_argument('--backbone', type=str, default='TGAT', help='Which GNN backbone to use with STAMPEDE',
...
def load_link_prediction_best_configs(args: argparse.Namespace):
    ...
    :return:
    """
    # This function remains unchanged, as STAMPEDE is a new model without pre-tuned configs.
    ...
    elif args.model_name != 'STAMPEDE':
        raise ValueError(f"Wrong value for model_name {args.model_name}!")

# --- END OF FILE load_configs.py ---