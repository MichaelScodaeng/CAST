...
class CAWN(nn.Module):
    ...
    def __init__(self, node_raw_features: np.ndarray, edge_raw_features: np.ndarray, neighbor_sampler: NeighborSampler,
                 time_feat_dim: int, position_feat_dim: int, walk_length: int = 2, num_walk_heads: int = 8, 
    ...
    def compute_node_temporal_embeddings(self, node_ids: np.ndarray, node_interact_times: np.ndarray, node_multi_hop_graphs: tuple, num_neighbors: int = 20):
        ...
        if self.feature_preprocessor is not None:
            batch_size, num_walks, seq_len = nodes_neighbor_ids.shape
            
            # Flatten to process all nodes at once
            ...
            neighbor_raw_features = processed_features_flat.view(batch_size, num_walks, seq_len, -1)
        else:
        ...
        # ... (rest of the function is IDENTICAL, it will use the new `neighbor_raw_features`) ...
